...
(function() {
    ...
    var implementation= function (variantName) {
        ...
        calcMoveScores.oppMax= function () {
            scores= [];
        ...
        var calcMoveScore= calcMoveScores[variantName];
    ...
    var variants= {
        "oppMax": "oppMax",
        "ck": "Carsten's version",
        "test1": "Test",
    };
    
    for ( var name in variants ) {
        Reversi.addEngine({
            name:       "raisin.montecarlo." + name,
            author:     "D.Raisin",
            email:      "info1@raisin.de",
            version:    "2010030100",
            title:      "Monte Carlo, " + variants[name],
